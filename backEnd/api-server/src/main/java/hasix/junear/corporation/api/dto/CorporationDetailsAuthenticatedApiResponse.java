...
@Getter
public class CorporationDetailsAuthenticatedApiResponse {
    ...
    @Builder
    public CorporationDetailsAuthenticatedApiResponse(Long corporation_id, Long industry_id,
            String industry_type, String corporation_code,
            String name, Double stability_rank, Double growth_rank, Double profitability_rank,
            Double activity_rank,
            Double total_rank, Long stock_close, Boolean isBookmarked) {
    ...
    public static CorporationDetailsAuthenticatedApiResponse from(
            ViewCorporationDetailsAuthenticatedResponse result) {
        return CorporationDetailsAuthenticatedApiResponse.builder()
