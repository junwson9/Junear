...
function CreatePortSearch({ onSearchResultsChange }: SearchPlaceHolderProps) {
  ...
  return (
    <>
      <div className=" w-[100%] bg-zinc-700 rounded-[10px]  border-b border-neutral-400 items-center">
...
export default CreatePortSearch;
